...
Use `scope:` to add a prefix to all captured variables.

- The scope value must match the regular expression `^[a-zA-Z0-9_][a-zA-Z0-9_]*[a-zA-Z0-9_]$`

- All output variables generated by a step are prefixed with the scope value
...
- [test-scope.yaml](https://github.com/verifyica-team/pipeliner/blob/main/tests/test-scope.yaml)
