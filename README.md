...
```bash
curl -s https://raw.githubusercontent.com/verifyica-team/pipeliner/main/install.sh | bash -s -- 0.28.0
```
...
```shell
@info Verifyica Pipeliner 0.28.0 (https://github.com/verifyica-team/pipeliner)
