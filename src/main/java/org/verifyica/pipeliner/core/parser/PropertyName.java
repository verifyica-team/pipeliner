...
/**
 * Utility class to validate a property name.
 */
public class PropertyName {
    ...
    /**
     * Method to check if a property name is valid
     *
     * @param name the name
    ...
    /**
     * Method to check if a property name is invalid
     *
     * @param name the name
     * @return true if the property name is invalid, false otherwise
     */
