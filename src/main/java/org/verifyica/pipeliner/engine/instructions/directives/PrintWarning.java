...
/**
 * Instruction to print a warning message.
 */
public class PrintWarning implements Instruction {

    /**
     * Logger for this class
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(PrintWarning.class);

    /**
     * Prefix for the directive
     */
    public static final String PREFIX = "--print:warning";
     ...
     * @param line the line
     */
    private PrintWarning(String line) {
        this.line = line;
    }
    ...
    public void execute(Context context, PeekIterator<Instruction> peekIterator) throws Throwable {
        ...
        context.getConsole().warning(resolvedMessage);
    }
     ...
     */
    public static PrintWarning of(String line) {
        return new PrintWarning(line);
    }
}
