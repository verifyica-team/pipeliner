...
public class ShaChecksum {
    ...
    public static Algorithm getAlgorithm(String checksum) throws ShaChecksumException {
        ...
        switch (length) {
            ...
            default: {
                throw new ShaChecksumException("error decoding algorithm for checksum [" + checksum + "]");
            }
        }
    }
     ...
     * @param file the file
     * @return the checksum
     * @throws ShaChecksumException If the algorithm is not supported or an error occurs
     */
    public static String checksum(Algorithm algorithm, Path file) throws ShaChecksumException {
        ...
        try {
            ...
            throw new ShaChecksumException("error calculating SHA-256 checksum", t);
        }
    }
}
